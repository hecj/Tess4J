...
#include <iostream>
#include"test_opencv_ImgCorrectTilt.h"
...
//#define DEGREE 27
JNIEXPORT int JNICALL JNICALL Java_test_opencv_ImgCorrectTilt_correct(JNIEnv *env, jclass,jstring inFile, jstring outFile)
//int main(int argc, char **argv)
{
    ...
    imwrite("/Users/hecj/Desktop/image/imageText_R.jpg",srcImg);
#endif
