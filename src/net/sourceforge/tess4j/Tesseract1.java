...
//        }
     ...
     */
    @Override
    public List<Word1> getWords(BufferedImage bi, int pageIteratorLevel) {
        this.init();
        this.setTessVariables();

        List<Word1> words = new ArrayList<Word1>();
        ...
        try {
            ...
            do {
                ...
                Word1 word = new Word1(text, confidence, new Rectangle(left, top, right - left, bottom - top));
                words.add(word);
